      ...
      <div className= "container pt-5 text-white">
        <div  className={`${FooterStyles.divider} row  pb-4`}>
          ...
          <div className=" offset-lg-2 offset-md-1 col-md-2 mb-4 mb-md-0">
            <h4 className='text-uppercase mb-3 fw-bold'>borame</h4>
            <ul>
        ...
        <div className='py-4 text-center'>
            <p className={`${FooterStyles.navlinkCustom} m-0 d-inline-block`}>Copyright &copy; 2024 Borame Inc. All rights reserved.</p>
          </div>
